...
const productos = () =>{
    ...
    mostrarProducto(yerbamate, mates, bombilla, accesorios, productosArreglo);

}

const mostrarProducto = (yerbamate, mates, bombilla, accesorios, todos) =>{
    btnYerbamate.addEventListener('click', ()=>{
        limpiarHtml(contenedorProducto);
        yerbamate.forEach(yerbamate=> contenedorProducto.appendChild(yerbamate));
    });
