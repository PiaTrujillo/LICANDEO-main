...
const btnYerbaMates = document.querySelector('.yerbamate');
const btnMate = document.querySelector('.mates');
...
const mostrarProductos = (yerbamate, mates, bombilla, accesorios, todos) =>{
    btnYerbaMates.addEventListener('click', ()=>{
    ...
    btnBombillas.addEventListener('click', ()=>{
        limpiarHtml(contenedorProductos);
